...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> MeroTravel-Package Details</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
